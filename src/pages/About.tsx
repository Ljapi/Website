    ...
    <div className="pt-20">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">Über uns</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6">Wer wir sind</h2>
            ...
            <div className="relative order-1 lg:order-2">
              <img
                ...
                className="w-full h-auto max-w-full object-contain rounded-xl shadow-md bg-transparent"
                loading="lazy"
              />
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6">Unsere Mission</h2>
              <p className="text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed mb-4">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">Warum uns wählen?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3">Erfahrung</h3>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3">Schnelligkeit</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3">Zuverlässigkeit</h3>
              <p className="text-sm sm:text-base text-gray-600">
