  ...
  const services = [
    {
      ...
      description: 'Professionelle Wasserinstallationen für Ihr Zuhause oder Unternehmen. Von der Planung bis zur Installation.',
      link: '/services/water-installation',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Hochwertige Verputz- und Malerarbeiten für Innen- und Außenbereiche. Perfekte Oberflächengarantie.',
      link: '/services/plastering-painting',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Moderne Heizungstechnologien und energieeffiziente Lösungen für optimale Raumtemperatur.',
      link: '/services/heating-technologies',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Umfassende Bauleistungen von der Grundsteinlegung bis zur Schlüsselübergabe.',
